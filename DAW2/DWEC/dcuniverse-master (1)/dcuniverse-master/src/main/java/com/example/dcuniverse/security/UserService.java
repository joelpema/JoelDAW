...
public class UserService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        else if ("wayne".equals(username)){
            return User.builder()
                    .username("wayne")
                    .password(passwordEncoder.encode("soybatman")) // password: "password" encriptado con BCrypt "$2a$10$VbG.Kpt2RLu.XXd45BtLxO4Wm9Md5OHJdV8xOQdfgJKOR9DBeVi3m"
                    .roles("ADMIN")
                    .build();
